...
$question{question_number}->setText("{text}");
$question{question_number}->setCategory("{category}");
$em->persist($question{question_number});"""
...
with open(file_name, 'r') as f:
    for line in f:
        ...
        print PHP_CODE_TEMPLATE.format(text=text.strip(), category=question_category,
